...
#log values of balance 
log10(bankdata$balance)[c(1:100)] 
# printing exponential values of first 100 entries of balance
print(exp(bankdata$balance)[c(1:100)]) 
cube<-((bankdata$balance)^3)[c(1:100)] #cube of balance values
print(cube)
